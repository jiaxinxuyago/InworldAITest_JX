...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UJakubSimpleParticleComponent_AttachComponentToParticle_Statics::NewProp_Parent = { "Parent", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(JakubSimpleParticleComponent_eventAttachComponentToParticle_Parms, Parent), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UJakubSimpleParticleComponent_AttachComponentToParticle_Statics::NewProp_Parent_MetaData), Z_Construct_UFunction_UJakubSimpleParticleComponent_AttachComponentToParticle_Statics::NewProp_Parent_MetaData) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UJakubSimpleParticleComponent_AttachComponentToParticle, "AttachComponentToParticle" }, // 2890391131
		{ &Z_Construct_UFunction_UJakubSimpleParticleComponent_FindBetweenNormals, "FindBetweenNormals" }, // 3219734538
		{ &Z_Construct_UFunction_UJakubSimpleParticleComponent_GetParticleCurrentLocation, "GetParticleCurrentLocation" }, // 1708487333
		{ &Z_Construct_UFunction_UJakubSimpleParticleComponent_SetAttachToParticleOffset, "SetAttachToParticleOffset" }, // 616012242
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_MaxAngleX = { "MaxAngleX", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UJakubSimpleParticleComponent, MaxAngleX), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_MaxAngleX_MetaData), Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_MaxAngleX_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_MaxAngleZ = { "MaxAngleZ", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UJakubSimpleParticleComponent, MaxAngleZ), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_MaxAngleZ_MetaData), Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_MaxAngleZ_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_ScalarDampingFactor = { "ScalarDampingFactor", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UJakubSimpleParticleComponent, ScalarDampingFactor), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_ScalarDampingFactor_MetaData), Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_ScalarDampingFactor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_MaxDistanceBetweenParticles = { "MaxDistanceBetweenParticles", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UJakubSimpleParticleComponent, MaxDistanceBetweenParticles), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_MaxDistanceBetweenParticles_MetaData), Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_MaxDistanceBetweenParticles_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_DistanceSolverIterations = { "DistanceSolverIterations", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UJakubSimpleParticleComponent, DistanceSolverIterations), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_DistanceSolverIterations_MetaData), Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_DistanceSolverIterations_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_GravityForce = { "GravityForce", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UJakubSimpleParticleComponent, GravityForce), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_GravityForce_MetaData), Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_GravityForce_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_DrawDebugShapes = { "DrawDebugShapes", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UJakubSimpleParticleComponent), &Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_DrawDebugShapes_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_DrawDebugShapes_MetaData), Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_DrawDebugShapes_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_RotationUpdateInterpSpeed = { "RotationUpdateInterpSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UJakubSimpleParticleComponent, RotationUpdateInterpSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_RotationUpdateInterpSpeed_MetaData), Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_RotationUpdateInterpSpeed_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_LocationUpdateInterpSpeed = { "LocationUpdateInterpSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UJakubSimpleParticleComponent, LocationUpdateInterpSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_LocationUpdateInterpSpeed_MetaData), Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_LocationUpdateInterpSpeed_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_UseRelativeRotationUpdate = { "UseRelativeRotationUpdate", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UJakubSimpleParticleComponent), &Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_UseRelativeRotationUpdate_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_UseRelativeRotationUpdate_MetaData), Z_Construct_UClass_UJakubSimpleParticleComponent_Statics::NewProp_UseRelativeRotationUpdate_MetaData) };
	...
	struct Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS__Version_3_0__UE5_3_Plugins_JakubCableComponent_Source_JakubCableComponent_Public_JakubSimpleParticleComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS__Version_3_0__UE5_3_Plugins_JakubCableComponent_Source_JakubCableComponent_Public_JakubSimpleParticleComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UJakubSimpleParticleComponent, UJakubSimpleParticleComponent::StaticClass, TEXT("UJakubSimpleParticleComponent"), &Z_Registration_Info_UClass_UJakubSimpleParticleComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UJakubSimpleParticleComponent), 1316742811U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS__Version_3_0__UE5_3_Plugins_JakubCableComponent_Source_JakubCableComponent_Public_JakubSimpleParticleComponent_h_2382758371(TEXT("/Script/JakubCableComponent"),
		Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS__Version_3_0__UE5_3_Plugins_JakubCableComponent_Source_JakubCableComponent_Public_JakubSimpleParticleComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS__Version_3_0__UE5_3_Plugins_JakubCableComponent_Source_JakubCableComponent_Public_JakubSimpleParticleComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
