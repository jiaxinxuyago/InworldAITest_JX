...
void FExecuteTickDelegate_DelegateWrapper(const FMulticastScriptDelegate& ExecuteTickDelegate)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_TimerFunction_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_TimerFunction_RunTimerTask, "RunTimerTask" }, // 1878584915
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_TimerFunction_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS_GAS_Plugin_5_3_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_AbilityTask_TimerFunction_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS_GAS_Plugin_5_3_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_AbilityTask_TimerFunction_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_TimerFunction, UAbilityTask_TimerFunction::StaticClass, TEXT("UAbilityTask_TimerFunction"), &Z_Registration_Info_UClass_UAbilityTask_TimerFunction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_TimerFunction), 2443682905U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS_GAS_Plugin_5_3_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_AbilityTask_TimerFunction_h_2042036111(TEXT("/Script/IWALS_AbilitySystem"),
		Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS_GAS_Plugin_5_3_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_AbilityTask_TimerFunction_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS_GAS_Plugin_5_3_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_AbilityTask_TimerFunction_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
