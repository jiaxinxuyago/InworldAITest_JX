...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UIWALS_AbilityInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UIWALS_AbilityInterface_GASBPI_CallToCurrentActivatedAbility, "GASBPI_CallToCurrentActivatedAbility" }, // 2430958295
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UIWALS_AbilityInterface_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS_GAS_Plugin_5_3_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AbilityInterface_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS_GAS_Plugin_5_3_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AbilityInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UIWALS_AbilityInterface, UIWALS_AbilityInterface::StaticClass, TEXT("UIWALS_AbilityInterface"), &Z_Registration_Info_UClass_UIWALS_AbilityInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIWALS_AbilityInterface), 1914007954U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS_GAS_Plugin_5_3_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AbilityInterface_h_1217970883(TEXT("/Script/IWALS_AbilitySystem"),
		Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS_GAS_Plugin_5_3_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AbilityInterface_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE___Projects_UE5_3_IWALS_GAS_Plugin_5_3_Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_IWALS_AbilityInterface_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
